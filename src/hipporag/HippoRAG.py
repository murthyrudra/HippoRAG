...
class HippoRAG:
    ...
    def __init__(
        ...
        self.global_config.extra_headers = extra_headers

        self.global_config.openie_mode = "online"
    ...
    def index(self, docs: List[str]):
        ...
        logger.warning(f"Indexing Documents")

        logger.warning(f"Performing OpenIE")
